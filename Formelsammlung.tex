...
%	Hauptext
% -----------------------------------------------------------------------------------------
\DeclarePairedDelimiter\abs{\lvert}{\rvert} % Betragsstriche
...
$$ \frac{\Delta E_{pot}}{q} = \Delta \varphi =  U $$
Plattenkondensator:
$$ \vec{E}=\frac{U}{\vec{d}} $$
...
Induktionsspannung (Stab):
$$ U_{ind}=\abs{\vec{B}\cdot l \times \vec{v}} $$
Induktionsspannung (Spule):
$$ U_{ind}=n \cdot \frac{\Delta \left(\vec{B}\cdot \vec{A}\right)}{\Delta t} = n \cdot \frac{\Delta \Phi}{\Delta t} $$
Induktivität (Spule):
...
\cfoot{\tiny{Version 1.10.1 -- \copyright 2014-2024 Dirk Winkel, \LaTeX-Source and document licenced under GPL version 3 or newer -- download: polarwinkel.de}}
